...
import { HelpCircle, X, Shield, Clock, FileText, UserCheck } from "lucide-react";
  ...
  const faqs = [
    {
      ...
      answer: "CNIC should be in the format: 12345-1234567-1 (5 digits, hyphen, 7 digits, hyphen, 1 digit). You can also use the scan feature to automatically extract CNIC from your card image.",
      icon: FileText
    },
    {
      id: "letter",
      question: "What is Letter ID format?",
      answer: "Letter ID should start with 'LTR-' followed by exactly 5 digits. Example: LTR-12345. This is provided by the Pakistan Bar Council.",
      icon: FileText
    },
    {
      id: "verify",
    ...
    },
    {
      ...
      answer: "Automatic verification is instant if your credentials are in our database. If manual review is needed, it typically takes 24-48 hours for admin approval.",
      icon: Clock
    },
    {
      id: "rejected",
        ...
        <Card className="absolute bottom-16 right-0 w-96 shadow-2xl slide-up border-0 bg-white">
          <CardHeader className="bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-t-lg relative">
            <div className="flex justify-between items-center">
              <div>
                <CardTitle className="text-lg font-semibold">Help Center</CardTitle>
                <p className="text-sm opacity-90">Frequently Asked Questions</p>
              </div>
              <Button
